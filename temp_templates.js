...
const baseTemplates = [
    // ðŸ´â€â˜ ï¸ HOLIDAYPIRATES DEMO TEMPLATE - Exact match for their first mission
    {
      name: 'ðŸ´â€â˜ ï¸ HolidayPirates Deal Research Agent',
      ...
      nodes: [
        ...
        },
        {
          ...
          position: { x: 300, y: 50 },
          data: {
            label: 'ðŸ“Š Travel Trend Analyst',
        ...
        },
        {
          ...
          data: {
            label: 'ðŸ•·ï¸ Deal Discovery Crawler',
        ...
        },
        {
          ...
          data: {
            label: 'ðŸ“‹ Data Processing Specialist',
        ...
        },
        {
          ...
          data: {
            label: 'âœï¸ Deal Content Creator',
        ...
        },
        {
          ...
          data: {
            label: 'ðŸ“Š Google Sheets Export',
    ...
    {
      name: 'ðŸ”‘ API Key Test - Simple Agent + Task',
    ...
    {
      name: 'ðŸ”¥ Simple Crypto Data Extractor',
...
ðŸ“Š INPUT: DexScreener API response with "pairs" array
ðŸ“¤ OUTPUT: Format like this:

ðŸ”¥ CRYPTO DATA UPDATE:

Token: [baseToken.name] ([baseToken.symbol])
ðŸ’° Price: $[priceUsd]
ðŸ’§ Liquidity: $[liquidity.usd]
ðŸ“Š Volume 24h: $[volume.h24]
ðŸ“ˆ Change 24h: [priceChange.h24]%
ðŸ”— Chain: [chainId]

---
â° Updated: [current timestamp]
...
REMEMBER: Extract data only, no advice!`,
    ...
    {
      name: 'ðŸ§ª Field Detection Test',
    ...
    },
    {
      ...
      description: 'ðŸ”„ Comprehensive market analysis of automation platforms: n8n, Make.com, Zapier with competitive positioning',
      ...
      nodes: [
        ...
        },
        {
          ...
          data: {
            ...
            expectedOutput: 'Lead score 0â€“100',
            async: false,
            nodeId: 'task-score-1',
            nodeType: 'task'
          }
    ...
    // NEW: Market Analysis AI Agent Template
    {
      ...
      description: 'ðŸ”¥ Professional market research workflow with AI-powered analysis and comprehensive reporting',
    ...
    // Simple Test Flow Template
    {
      ...
      description: 'ðŸš€ Basic workflow with Input â†’ Agent â†’ Task for testing',
    ...
    // Marketing Campaign Analyzer Template
    {
      ...
      description: 'ðŸ“Š Comprehensive marketing campaign analysis with performance insights and recommendations',
    ...
    // Email Marketing Automation Template
    {
      ...
      description: 'ðŸ“§ Automated email marketing workflow with personalization and segmentation',
    ...
    // Social Media Content Generator Template
    {
      ...
      description: 'ðŸ“± AI-powered social media content creation for multiple platforms',
    ...
    // NEW: Targeted Column Research Template
    {
      ...
      description: 'ðŸŽ¯ Smart agent that only processes specific columns (topic + description) and triggers only on new data',
    ...
    {
      name: 'ðŸ”¥ WORKING DexScreener Live Monitor',
...
REMEMBER: Extract data only, no advice!`,
    ...
    {
      name: 'ðŸ§  Smart Crypto Monitor with Field Filtering',
      ...
      nodes: [
        {
          ...
          position: { x: 100, y: 100 },
          data: {
            label: 'ðŸ§  Smart DexScreener Monitor',
            triggerType: 'universal_polling',
            serviceName: 'DexScreener',
            apiEndpoint: 'https://api.dexscreener.com/latest/dex/search?q=PEPE',
            pollingInterval: 60,
        ...
        },
        {
          ...
          position: { x: 350, y: 100 },
          data: {
            label: 'ðŸ§  Smart Crypto Analyzer',
...
ðŸŽ¯ INPUT FORMAT: You receive a clean summary of top crypto pairs with only essential fields:
- Token Symbol & Name
- Current Price (USD)
- Liquidity (USD) 
- 24h Volume
...
ðŸ“Š YOUR TASK: Create a concise crypto market digest

ðŸ”¥ OUTPUT FORMAT:
ðŸ“ˆ CRYPTO MARKET DIGEST

ðŸª™ TOP TOKENS:
â€¢ [Symbol]: $[Price] ([Change]%) - Vol: $[Volume] - Chain: [Chain]
â€¢ [Symbol]: $[Price] ([Change]%) - Vol: $[Volume] - Chain: [Chain]
â€¢ [Symbol]: $[Price] ([Change]%) - Vol: $[Volume] - Chain: [Chain]
...
Keep it under 500 characters for Telegram efficiency!`,
        ...
        },
        {
          ...
          position: { x: 600, y: 100 },
          data: {
            label: 'ðŸ“Š Generate Market Digest',
        ...
        },
        {
          ...
          position: { x: 850, y: 100 },
          data: {
            label: 'ðŸ“± Smart Telegram Sender',
    ...
    {
      name: 'ðŸ¢ Enterprise Multi-Agent Business Intelligence Platform',
      description: 'Complete end-to-end business automation testing ALL node types: Triggers â†’ Multiple Agents â†’ Tasks â†’ Tools â†’ Logic â†’ Outputs. Real-world enterprise workflow with market research, competitor analysis, content generation, and multi-channel distribution.',
      ...
      nodes: [
        // 1. TRIGGER NODE - Universal Polling for Market Data
        {
          ...
          position: { x: 100, y: 200 },
          data: {
            label: 'ðŸ“Š B2B Market Data Monitor',
            triggerType: 'universal_polling',
        ...
        // 3. AGENT 1 - Market Research Specialist
        {
          ...
          data: {
            label: 'ðŸ” Market Research Specialist',
            role: 'Senior Market Research Analyst',
        ...
        // 5. AGENT 2 - Content Strategy Specialist
        {
          ...
          data: {
            label: 'âœï¸ Content Strategy Specialist',
        ...
        // 8. TOOL 1 - Competitor Analysis Tool
        {
          ...
          data: {
            label: 'ðŸ” Competitor Analysis Tool',
        ...
        // 9. AGENT 3 - Business Intelligence Analyst
        {
          ...
          data: {
            label: 'ðŸ“Š Business Intelligence Analyst',
        ...
        // 13. TASK 5 - Distribution Optimization
        {
          ...
          data: {
            label: 'ðŸŽ¯ Distribution Optimization',
        ...
        // 19. AGENT 5 - Performance Analyst (for follow-up)
        {
          ...
          data: {
            label: 'ðŸ“Š Performance Analyst',
        ...
        // 20. TASK 6 - Performance Analysis
        {
          ...
          data: {
            label: 'ðŸ“ˆ Performance Analysis',
      ...
      edges: [
        // Primary flow: Trigger â†’ Market Research
        {
          ...
          type: 'animated',
          animated: true,
          data: { label: 'ðŸ“Š Market Data' }
        },
        // Input â†’ Market Research
        {
          ...
          type: 'animated',
          animated: true,
          data: { label: 'ðŸŽ¯ Business Context' }
        },
        // Market Research â†’ Analysis Task
        {
          ...
          type: 'animated',
          animated: true,
          data: { label: 'ðŸ” Research' }
        },
        // Market Research â†’ Content Strategy
        {
          ...
          type: 'animated',
          animated: true,
          data: { label: 'ðŸ“Š Market Insights' }
        },
        // Content Strategy â†’ Strategy Task
        {
          ...
          type: 'animated',
          animated: true,
          data: { label: 'âœï¸ Strategy' }
        },
        // Content Strategy â†’ Creation Task
        {
          ...
          type: 'animated',
          animated: true,
          data: { label: 'ðŸŽ¨ Content' }
        },
        // Analysis Task â†’ Competitor Tool
        {
          ...
          type: 'animated',
          animated: true,
          data: { label: 'ðŸ” Analysis Data' }
        },
        // Competitor Tool â†’ BI Agent
        {
          id: 'edge-tool-bi',
          ...
          type: 'animated',
          animated: true,
          data: { label: 'ðŸ•µï¸ Competitor Intel' }
        },
        // Content Tasks â†’ BI Agent
        {
          id: 'edge-strategy-bi',
        ...
        // BI Agent â†’ BI Report
        {
          ...
          type: 'animated',
          animated: true,
          data: { label: 'ðŸ“Š Intelligence' }
        },
        // BI Report â†’ Quality Gate
        {
          ...
          type: 'animated',
          animated: true,
          data: { label: 'ðŸ“‹ Report' }
        },
        // Quality Gate â†’ Distribution (TRUE path)
        {
          ...
          type: 'animated',
          animated: true,
          data: { label: 'âœ… High Quality' }
        },
        // Distribution â†’ Optimization
        {
          ...
          type: 'animated',
          animated: true,
          data: { label: 'ðŸ“¤ Distribution' }
        },
        // Optimization â†’ Email Output
        {
        ...
        // Quality Gate â†’ Database (FALSE path)
        {
          ...
          type: 'animated',
          animated: true,
          data: { label: 'âš ï¸ Needs Review' }
        },
        // Distribution â†’ Analytics Tool
        {
        ...
        // Analytics â†’ Delay
        {
          ...
          type: 'animated',
          animated: true,
          data: { label: 'â° Schedule' }
        },
        // Delay â†’ Performance Agent
        {
          ...
          type: 'animated',
          animated: true,
          data: { label: 'â° Follow-up' }
        },
        // Performance Agent â†’ Performance Task
        {
      ...
      metadata: {
        ...
        outputCount: 3,
        features: [
          'ðŸ”„ Real-time market data monitoring',
          'ðŸ¤– 5 specialized AI agents with different expertise',
          'ðŸ“Š Comprehensive business intelligence generation',
          'ðŸŽ¯ Logic-based quality gates and routing',
          'ðŸ“¤ Multi-channel content distribution',
          'â° Scheduled follow-up analysis',
  ...
  return edges.map(edge => {
    if (edge.type === 'smoothstep' || !edge.type) {
      ...
      const getLabelFromConnection = (sourceId, targetId, dataType) => {
        const labelMap = {
          'api': 'ðŸ” API Data',
          'agent': 'ðŸ¤– Agent Response',
          'task': 'ðŸŽ¯ Task Result',
          'tool': 'ðŸ”§ Tool Output',
          'text': 'ðŸ“ Text Data',
          'output': 'ðŸ“¤ Output',
          'webhook': 'ðŸ”— Webhook',
        ...
        return labelMap[dataType] || 'ðŸ“Š Data Flow';
      };
...
export const flowTemplates = [
  ...
  // ðŸŽ¯ LinkedIn Lead Generation & Outreach Automation Template
  {
    id: "linkedin-lead-automation",
    name: "ðŸŽ¯ LinkedIn Lead Generation & Outreach Automation",
    description: "Complete automation pipeline: Website scraping â†’ Lead qualification â†’ LinkedIn research â†’ Personalized outreach generation. Get 50-100 qualified leads with 35-45% response rate potential.",
    category: "Sales Automation",
    tags: ["linkedin", "lead-generation", "outreach", "web-scraping", "ai-automation", "sales"],
    difficulty: "Advanced",
    estimatedTime: "5-10 minutes per website",
    thumbnail: "ðŸŽ¯",
    
    // Success metrics and features
    features: [
      "ðŸ•·ï¸ Website lead scraping with AI extraction",
      "ðŸŽ¯ AI-powered lead qualification & scoring", 
      "ðŸ” Deep LinkedIn profile research",
      "âœï¸ Personalized message generation",
      "âœ… Quality control & compliance checking",
      "ðŸ“Š Complete lead database export",
      "ðŸ¤– Multi-framework AI orchestration",
      "ðŸ” BYOK compliant execution"
    ],
    
    requirements: {
      apiKeys: ["openai", "anthropic", "perplexity"],
      frameworks: ["universal_api", "crewai", "langchain"],
      tools: ["web_scraper", "linkedin_research", "message_generator"]
    },
    
    // Expected outcomes
    expectedOutcomes: [
      "50-100 qualified leads per website",
      "LinkedIn profiles researched and scored",
      "Personalized outreach messages generated",
      "35-45% response rate potential",
      "Complete lead database with contact info"
    ],
    
    // Workflow nodes
    nodes: [
      // ðŸŒ INPUT: Website URL
      {
        id: "website_input",
        type: "input",
        position: { x: 50, y: 200 },
        data: {
          label: "ðŸŒ Website Input",
          description: "Enter target website URL for lead scraping",
          inputType: "url",
          ...
          icon: "ðŸŒ",
          outputs: ["website_url"],
          nodeId: "website_input",
          nodeType: "input"
        }
      },

      // ðŸ•·ï¸ TOOL: Web Scraper
      {
        id: "web_scraper",
        type: "tool", 
        position: { x: 300, y: 200 },
        data: {
          label: "ðŸ•·ï¸ Website Lead Scraper",
          description: "AI-powered web scraping to extract potential leads from target website",
          toolType: "universal_api",
          framework: "universal_api",
          
          config: {
            api_service_name: "web_scraper_pro",
            api_endpoint_hint: "https://api.scrapfly.io/scrape",
            ai_description: "Extract contact information, team pages, employee profiles, and lead data from websites",
            api_research_result: {
              service_name: "Web Scraper Pro",
              ...
              endpoints: {
                scrape: {
                  ...
                  parameters: {
                    url: "string",
                    render_js: "boolean",
                    extract_contact: "boolean",
                    extract_team: "boolean"
                  }
                }
              }
            },
            extraction_rules: {
              contacts: ["email", "phone", "linkedin_url"],
              team_info: ["name", "title", "department"],
              company_info: ["size", "industry", "location"]
            }
          },
          
          inputs: {
            website_url: { from: "website_input", field: "website_url" },
            scraping_options: {
              render_js: true,
          ...
          outputs: ["scraped_leads", "company_info", "team_data"],
          icon: "ðŸ•·ï¸",
          estimatedTime: "2-3 minutes",
          nodeId: "web_scraper",
          nodeType: "tool"
      ...
      // ðŸŽ¯ AGENT: Lead Qualification
      {
        id: "lead_qualifier",
        type: "agent",
        position: { x: 600, y: 200 },
        data: {
          label: "ðŸŽ¯ AI Lead Qualifier",
          description: "Analyze and score scraped leads for LinkedIn outreach potential",
          framework: "crewai",
          role: "Lead Qualification Specialist",
          goal: "Score and qualify leads based on outreach potential and business relevance",
          backstory: "You are an expert B2B lead qualification specialist with deep experience in LinkedIn outreach success patterns.",
          
          config: {
            systemMessage: "You are an expert lead qualification specialist who analyzes scraped data to identify high-value LinkedIn outreach prospects.",
            agentType: "lead_analyst",
            
            // âœ… FIXED: Proper agent definitions for CrewAI
            agents: [
              {
                role: "Lead Scoring Analyst",
                goal: "Score leads based on title seniority, department relevance, and contact completeness",
                backstory: "Expert in B2B lead qualification with focus on LinkedIn outreach success rates",
                tools: ["data_analyzer", "linkedin_checker"]
              },
              {
                role: "Contact Enrichment Specialist", 
                goal: "Enrich lead data with additional context and LinkedIn profile matching",
                backstory: "Specializes in contact data enrichment and social profile matching",
                tools: ["contact_enricher", "social_verifier"]
              }
            ],
            
            // âœ… FIXED: Proper task structure for CrewAI
            tasks: [
              {
                description: "Analyze all scraped leads and assign qualification scores (0-100) based on outreach potential. Consider job title seniority, department relevance, company size, and contact completeness. Prioritize decision-makers in target departments.",
                expected_output: "JSON array of scored leads with fields: lead_id, name, title, company, score, qualification_reason, linkedin_url, contact_priority",
                agent: "Lead Scoring Analyst",
                tools: ["data_analyzer", "linkedin_checker"]
              },
              {
                description: "Take the top 20% scored leads and enrich their profiles with additional context, verify LinkedIn URLs, and add missing contact information where possible.",
                expected_output: "Enriched lead profiles with additional fields: industry, company_size, recent_activity, mutual_connections, contact_verified",
                agent: "Contact Enrichment Specialist", 
                tools: ["contact_enricher", "social_verifier"]
              }
            ],
            ...
            // Memory and collaboration settings
            memory: true,
            verbose: true,
            max_iterations: 3
          },
          ...
          inputs: {
            scraped_data: { from: "web_scraper", field: "scraped_leads" },
            company_context: { from: "web_scraper", field: "company_info" },
            qualification_criteria: {
              target_titles: ["CEO", "CTO", "VP", "Director", "Manager", "Head of", "Lead"],
              target_departments: ["Engineering", "Operations", "Sales", "Marketing", "Product", "Technology"],
              min_company_size: 10,
              industries: ["Technology", "SaaS", "E-commerce", "Software", "Fintech"]
            }
          },
          
          outputs: ["qualified_leads", "lead_scores", "enrichment_data"],
          icon: "ðŸŽ¯",
          estimatedTime: "3-4 minutes",
      ...
      // ðŸ” AGENT: LinkedIn Research
      {
        id: "linkedin_researcher", 
        type: "agent",
        position: { x: 900, y: 200 },
        data: {
          label: "ðŸ” LinkedIn Research Agent",
          description: "Deep LinkedIn profile research for personalized outreach insights",
          framework: "crewai",
          role: "LinkedIn Research Specialist",
          goal: "Extract comprehensive insights from LinkedIn profiles for highly personalized outreach",
          backstory: "You are an expert LinkedIn researcher who finds the perfect personalization hooks and conversation starters.",
          
          config: {
            systemMessage: "You are an expert LinkedIn research specialist who analyzes profiles to create compelling outreach angles and personalization strategies.",
            ...
            agents: [
              {
                ...
                goal: "Extract comprehensive insights from LinkedIn profiles for outreach personalization",
                backstory: "Expert at reading between the lines of LinkedIn profiles to find connection opportunities and conversation starters",
                tools: ["linkedin_scraper", "profile_analyzer"]
              },
              {
                role: "Company Intelligence Researcher",
                goal: "Research company context, recent news, funding, and market position for strategic outreach timing",
                backstory: "Specialist in company research and competitive intelligence with focus on outreach opportunities",
                tools: ["company_research", "news_analyzer"]
              }
            ],
            ...
            tasks: [
              {
                description: "For each qualified lead, research their LinkedIn profile in detail. Extract recent posts, career progression, interests, mutual connections, and any personalization hooks. Focus on finding authentic conversation starters.",
                expected_output: "Detailed profile analysis JSON with fields: lead_id, recent_activity, career_highlights, interests, mutual_connections, personalization_hooks, conversation_starters",
                agent: "LinkedIn Profile Analyst",
                tools: ["linkedin_scraper", "profile_analyzer"]
              },
              {
                description: "Research each lead's company for recent news, funding announcements, growth signals, and market position. Identify optimal outreach timing and company-specific talking points.",
                expected_output: "Company intelligence report JSON with fields: lead_id, company_news, funding_status, growth_signals, market_position, outreach_timing, company_hooks",
          ...
          inputs: {
            qualified_leads: { from: "lead_qualifier", field: "qualified_leads" },
            enrichment_data: { from: "lead_qualifier", field: "enrichment_data" },
            research_depth: "comprehensive"
          },
          
          outputs: ["research_insights", "personalization_hooks", "outreach_timing"],
          icon: "ðŸ”", 
          estimatedTime: "4-5 minutes",
          nodeId: "linkedin_researcher",
          nodeType: "agent"
        }
      },

      // âœï¸ AGENT: Message Generation
      {
        id: "message_generator",
        type: "agent",
        position: { x: 1200, y: 200 },
        data: {
          label: "âœï¸ Outreach Message Generator",
          description: "Generate personalized LinkedIn messages using research insights",
          framework: "langchain",
          role: "LinkedIn Outreach Specialist",
          goal: "Create highly personalized, authentic LinkedIn messages that generate responses",
          backstory: "You are a master of LinkedIn outreach who understands what makes prospects respond positively.",
          
          config: {
            chainType: "sequential",
            systemMessage: "You are an expert LinkedIn outreach specialist who creates highly personalized, authentic messages that generate responses. Focus on value, authenticity, and clear call-to-actions.",
            
            // âœ… FIXED: Proper LangChain sequential chain configuration
            chains: [
              {
                name: "personalization_strategy",
                description: "Create personalization strategy based on research insights",
                prompt: `Analyze the research data and create a personalization strategy for each lead:
...
For each lead, create a personalization strategy including:
1. Primary hook (recent activity, mutual connections, company news)
2. Value proposition alignment with their role/challenges
3. Authentic conversation starter
4. Appropriate call-to-action approach
5. Message tone and style recommendations

Output as JSON with lead_id and strategy details.`,
                input_variables: ["research_insights", "personalization_hooks", "lead_profile", "company_context"],
                output_key: "personalization_strategy"
              },
              {
                name: "message_generation", 
                description: "Generate personalized LinkedIn messages based on strategy",
                prompt: `Generate personalized LinkedIn outreach messages based on the personalization strategy:

Personalization Strategy: {personalization_strategy}
Sender Context: {sender_context}
Value Proposition: {value_proposition}

For each lead, generate:
1. LinkedIn connection request message (280 characters max, warm and personal)
2. Follow-up message (if connection is accepted - professional but friendly)
3. Direct message alternative (if unable to connect)
4. Subject line for InMail (if premium outreach needed)

Requirements:
- Authentic and conversational tone
- Clear value proposition
- Specific personalization based on research
- Appropriate call-to-action
- LinkedIn compliant (no spam language)

Output as JSON with lead_id and all message variants.`,
                input_variables: ["personalization_strategy", "sender_context", "value_proposition"],
                output_key: "generated_messages"
              }
            ],
          ...
          inputs: {
            research_insights: { from: "linkedin_researcher", field: "research_insights" },
            personalization_hooks: { from: "linkedin_researcher", field: "personalization_hooks" },
            outreach_timing: { from: "linkedin_researcher", field: "outreach_timing" },
            sender_context: {
              name: "AI Automation Specialist",
              company: "Nodai",
              title: "Founder & CEO",
              linkedin_url: "https://linkedin.com/in/nodai-founder",
              value_proposition: "AI automation platform helping teams eliminate repetitive work and scale intelligent decision-making with multi-framework orchestration"
            }
          },
          
          outputs: ["generated_messages", "personalization_scores", "outreach_sequences"],
          icon: "âœï¸",
          estimatedTime: "3-4 minutes",
          nodeId: "message_generator",
          nodeType: "agent"
        }
      },

      // âœ… TOOL: Quality Control
      {
        id: "quality_checker",
        type: "tool",
        position: { x: 1500, y: 200 },
        data: {
          label: "âœ… Message Quality Control",
          description: "AI-powered quality check and compliance validation",
          toolType: "llm",
          framework: "langchain",
          
          config: {
            chainType: "simple",
            systemMessage: "You are a LinkedIn compliance and message quality expert. Analyze outreach messages for effectiveness, compliance, and authenticity. Score each message and provide improvement recommendations.",
            
            // âœ… FIXED: Proper LangChain simple chain configuration
            prompt: `Analyze the generated LinkedIn messages for quality, compliance, and effectiveness:

Generated Messages: {generated_messages}
Quality Criteria: {quality_criteria}

For each message, evaluate:
1. LinkedIn compliance (no spam language, appropriate length)
2. Personalization quality (specific vs generic)
3. Value proposition clarity
4. Call-to-action effectiveness
5. Professional tone and authenticity
6. Response likelihood score (1-10)

Provide:
- Overall quality score (0-100) for each message
- Compliance status (APPROVED/NEEDS_REVIEW/REJECTED)
- Specific improvement suggestions
- Alternative versions if needed

Output as JSON with lead_id and detailed analysis.`,

            input_variables: ["generated_messages", "quality_criteria"],
          ...
          inputs: {
            generated_messages: { from: "message_generator", field: "generated_messages" },
            quality_criteria: {
              max_connection_length: 280,
              max_message_length: 300,
              tone: "professional_friendly",
              compliance: "linkedin_tos",
              spam_check: true,
              personalization_check: true,
              value_prop_required: true,
              cta_required: true
            }
          },
          
          outputs: ["quality_scores", "compliance_status", "improvement_suggestions", "approved_messages"],
          icon: "âœ…",
          estimatedTime: "1-2 minutes",
          nodeId: "quality_checker",
          nodeType: "tool"
        }
      },

      // ðŸ“Š OUTPUT: Results Export
      {
        id: "results_output",
        type: "output", 
        position: { x: 1800, y: 200 },
        data: {
          label: "ðŸ“Š Lead Database & Messages",
          description: "Complete lead database with research insights and personalized outreach messages",
          
          // âœ… FIXED: Proper output configuration
          config: {
            outputFormat: {
              leads_database: {
                format: "csv",
                ...
                fields: [
                  "lead_id", "name", "title", "company", "email", 
                  "linkedin_url", "lead_score", "qualification_reason",
                  "industry", "company_size", "contact_priority"
                ]
              },
              outreach_messages: {
                format: "json",
                filename: "linkedin_outreach_messages.json", 
                structure: [
                  "lead_id", "connection_request", "follow_up_message", 
                  "direct_message", "inmail_subject", "personalization_hooks",
                  "quality_score", "compliance_status"
                ]
              },
              research_insights: {
                format: "json",
                filename: "lead_research_insights.json",
                structure: [
                  "lead_id", "profile_analysis", "company_intelligence",
                  "personalization_strategy", "outreach_timing"
                ]
              },
              analytics: {
                format: "json",
                filename: "campaign_analytics.json",
                metrics: [
                  "total_leads_scraped", "qualified_leads_count", "avg_lead_score", 
                  "message_quality_scores", "compliance_pass_rate", "estimated_response_rate"
                ]
              }
            },
          ...
          inputs: {
            qualified_leads: { from: "lead_qualifier", field: "qualified_leads" },
            lead_scores: { from: "lead_qualifier", field: "lead_scores" },
            enrichment_data: { from: "lead_qualifier", field: "enrichment_data" },
            research_insights: { from: "linkedin_researcher", field: "research_insights" },
            personalization_hooks: { from: "linkedin_researcher", field: "personalization_hooks" },
            generated_messages: { from: "message_generator", field: "generated_messages" },
            quality_scores: { from: "quality_checker", field: "quality_scores" },
            compliance_status: { from: "quality_checker", field: "compliance_status" },
            approved_messages: { from: "quality_checker", field: "approved_messages" }
          },
          
          // âœ… FIXED: Export options
          exportOptions: [
            {
              label: "ðŸ“Š Download Lead Database (CSV)",
              action: "download_csv",
            ...
            },
            {
              ...
              target: "outreach_messages"
            },
            {
              label: "ðŸ” Download Research Insights (JSON)",
              action: "download_json", 
              target: "research_insights"
            },
            {
              label: "ðŸ“ˆ Download Analytics Report (JSON)",
              action: "download_json",
              target: "analytics"
            },
            {
              label: "ðŸ”— Export to CRM",
              action: "crm_export",
              options: ["salesforce", "hubspot", "pipedrive"]
            },
            {
              label: "ðŸ“§ Export to Email Platform",
              action: "email_export", 
              options: ["mailchimp", "constant_contact", "sendgrid"]
            },
            {
              label: "ðŸ’¼ Send to LinkedIn Sales Navigator",
              action: "linkedin_export",
              target: "sales_navigator"
            }
          ],
          
          outputs: ["export_status", "download_links", "integration_results"],
          icon: "ðŸ“Š",
          estimatedTime: "30 seconds",
          nodeId: "results_output",
          nodeType: "output"
        }
      }
    ],
    ...
    edges: [
      ...
      {
        id: "edge-scraper-qualifier",
        source: "web_scraper",
        target: "lead_qualifier",
        type: "animated",
        animated: true,
        data: {
          label: "ðŸ•·ï¸ Scraped Leads",
          dataType: "tool",
          state: "idle"
        }
      },
      {
        id: "edge-qualifier-researcher",
        source: "lead_qualifier",
        target: "linkedin_researcher",
        type: "animated",
        animated: true,
        data: {
          label: "ðŸŽ¯ Qualified Leads",
          dataType: "agent",
          state: "idle"
        }
      },
      {
        id: "edge-researcher-generator",
        source: "linkedin_researcher", 
        target: "message_generator",
        type: "animated",
        animated: true,
        data: {
          label: "ðŸ” Research Insights",
          dataType: "agent",
          state: "idle"
        }
      },
      {
        id: "edge-generator-quality",
        source: "message_generator",
        target: "quality_checker",
        type: "animated",
        animated: true,
        data: {
          label: "âœï¸ Generated Messages",
          dataType: "agent",
          state: "idle"
        }
      },
      {
        id: "edge-quality-output",
        source: "quality_checker",
        target: "results_output",
        type: "animated",
        animated: true,
        data: {
          label: "âœ… Quality Scores",
          dataType: "tool",
          state: "idle"
        }
      }
    ...
    metadata: {
      ...
      updated: "2025-01-01",
      author: "Nodai Team",
      templateType: "automation_workflow",
      ...
      roi_metrics: {
        ...
        execution_time: "15-20 minutes per 100 leads", 
        manual_equivalent: "40+ hours per 100 leads",
        cost_savings_per_lead: "$15-25",
        response_rate_improvement: "3x"
      }
    }
  },
  
  {
    ...
    name: "ðŸ§  Intelligent Incremental Data Processing",
    ...
    features: [
      "ðŸ” Smart change detection (multiple methods)",
      "ðŸ“Š Incremental record processing",
      "ðŸŽ¯ Intelligent field filtering",
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          label: "ðŸ¤– Incremental Data Processor",
      ...
      },
      {
        ...
        data: {
          label: "ðŸ“Š Processing Analytics",
...
`,
  ...
  },
  {
    ...
    name: "ðŸš€ Live Dex Coin Scanner & Auto-Buyer",
    ...
    features: [
      "ðŸ” Real-time DexScreener monitoring",
      "ðŸ§  AI-powered token analysis",
      "ðŸ’° Automated buying with risk management",
      "ðŸ“± Telegram notifications",
      "ðŸ›¡ï¸ Scam detection & filtering",
    ...
    nodes: [
      ...
      },
      {
        ...
        position: { x: 400, y: 150 },
        data: {
          label: "ðŸ§  Crypto Data Extractor",
          role: "Crypto Data Extraction Specialist",
      ...
      },
      {
        ...
        position: { x: 1300, y: 200 },
        data: {
          label: "ðŸ“± Telegram Notification",
    ...
    edges: [
      ...
      },
      {
        ...
        type: "smoothstep",
        animated: true,
        data: { label: "ðŸ“Š Analysis Results" }
      },
      {
        id: "e3-4",
    ...
    metadata: {
      ...
      riskWarnings: [
        "âš ï¸ CRYPTO TRADING IS HIGH RISK - Only invest what you can afford to lose",
        "âš ï¸ Test thoroughly with small amounts before scaling",
        "âš ï¸ Always use stop-losses and position sizing",
        "âš ï¸ Monitor for honeypots and rug pulls",
      ...
      profitPotential: [
        "ðŸ’° Early detection of 10-100x tokens",
        "ðŸš€ Automated 24/7 monitoring",
        "âš¡ Faster than manual traders",
        "ðŸŽ¯ Consistent strategy execution",
...
     . . . t e m p l a t e ,  
     e d g e s :   c o n v e r t T o A n i m a t e d E d g e s ( t e m p l a t e . e d g e s )  
 } ) ) ;  
  
 e x p o r t   d e f a u l t   f l o w T e m p l a t e s ;  
 