...
# Create a sample agent-task flow with proper connection handles
sample_flow = {
    "id": flow_id,
    "name": "Agent with Task Test - Fixed",
    "description": "A flow with agent and task nodes - with fixed connections",
...
print(f"Sample agent-task flow (with fixed connections) created successfully! Saved to {file_path}")
import json
import uuid
from datetime import datetime
