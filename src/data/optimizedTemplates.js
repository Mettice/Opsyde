...
export const optimizedTemplates = [
  // 🧪 NEW: Working Test Workflow (from backend test_simple_workflow.py)
  {
    name: '🧪 Working Test Workflow',
    description: 'Exact replica of the backend test that produces real results (robot painter story)',
    thumbnail: '/img/test-workflow.png',
    nodes: [
      {
        id: 'input-test-data',
        type: 'input',
  ...
  // 🐛 NEW: Debug Template - Input Processing Test
  {
    name: '🐛 Debug Input Processing',
    description: 'Debug template to see exactly how input is processed and passed between nodes',
    thumbnail: '/img/debug-workflow.png',
    nodes: [
      {
        id: 'input-debug',
        type: 'input',
        ...
        data: {
          ...
          description: 'Simple question to test input processing',
      ...
      },
      {
        ...
        data: {
          ...
          goal: 'Answer questions directly and clearly without asking for more details',
          backstory: 'You are a helpful assistant that answers questions directly. When given a question, you provide a clear, concise answer without asking for clarification.',
          framework: 'crewai',
          tools: [],
          frameworkConfig: {
            provider: 'openai',
      ...
      },
      {
        ...
        data: {
          label: '📋 Debug Task',
          description: 'Process the input and provide a direct answer',
          expectedOutput: 'A clear, direct answer to the input question',
          agentRef: 'agent-debug',
          nodeId: 'task-debug',
          nodeType: 'task'
        }
      },
      {
        ...
        data: {
          label: '📊 Debug Output',
          outputType: 'structured',
          description: 'Show the complete data flow for debugging',
          config: {
            format: 'json',
    ...
    edges: [
      { id: 'e1', source: 'input-debug', target: 'agent-debug' },
      { id: 'e2', source: 'agent-debug', target: 'task-debug' },
      { id: 'e3', source: 'task-debug', target: 'output-debug' }
    ]
  },
